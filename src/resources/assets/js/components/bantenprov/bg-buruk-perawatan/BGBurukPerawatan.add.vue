    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/bg-buruk-perawatan/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/bg-buruk-perawatan/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/bg-buruk-perawatan/create'
                  }
                },
                window.location.href = '#/admin/bg-buruk-perawatan/create')
        ...
        back() {
            window.location = '#/admin/bg-buruk-perawatan';
        }
    },
    mounted: function() {
        axios.get("/bg-buruk-perawatan/create").then(response => {
