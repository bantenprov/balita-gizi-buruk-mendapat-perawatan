    ...
    <div class="row">
      <div class="col-lg-6 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #2196F3;">
          <div class="card-body">
            <bg-buruk-perawatan-bar-03></bg-buruk-perawatan-bar-03>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
      <div class="col-lg-6 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #4CAF50;">
          <div class="card-body">
            <bg-buruk-perawatan-pie-03></bg-buruk-perawatan-pie-03>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
    </div><!-- /.row -->
    ...
    <div class="row">
      <div class="col-lg-8 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #009688;">
          ...
          <div class="card-body">
            <bg-buruk-perawatan-bar-01></bg-buruk-perawatan-bar-01>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
    ...
    <div class="row">
      ...
      <div class="col-lg-6 mb-3">
        <div class="card text-white bg-dark h-100">
          ...
          <div class="card-body">
            <bg-buruk-perawatan-bar-02></bg-buruk-perawatan-bar-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
    </div><!-- /.row -->
